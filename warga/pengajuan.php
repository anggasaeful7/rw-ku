        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: #435ebe;">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" data-bss-hover-animate="bounce" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item"><a class="nav-link" data-bss-hover-animate="pulse" href="index.php"><svg></svg><span><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-house-fill" style="font-size: 21px;">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Pengajuan Surat&nbsp;</h3>
                </div>
                <div class="card shadow">
                    ...
                    <div class="card-body" style="height: 120px;">
                        <div class="card-group">
                            <div class="card"><img class="card-img-top w-100 d-block" src="assets/img/kk.png">
                                <div class="card-body">
                                    <h4 class="text-center card-title" style="margin-left: 0px;">Silahkan Pilih KK Anda</h4>
                                    <div class="dropdown show"><button class="btn btn-primary dropdown-toggle text-center" aria-expanded="true" data-bs-toggle="dropdown" data-bss-hover-animate="pulse" type="button" style="margin-right: 0px;margin-bottom: 0px;margin-left: 248px;">Pilih KK</button>
                                        <div class="dropdown-menu show" data-bs-popper="none"><a class="dropdown-item" href="#">12313131231123</a><a class="dropdown-item" href="#">23424234234344</a><a class="dropdown-item" href="#">67456456464554</a></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card"><img class="card-img-top w-100 d-block" src="assets/img/Tanpa%20judul%20(470%20×%2080%20piksel).png">
                                <div class="card-body">
                                    <h4 class="text-center card-title" style="margin-left: -8px;">Silahkan Pilih Jenis Surat</h4>
                                    <div class="dropdown show"><button class="btn btn-primary dropdown-toggle text-center" aria-expanded="true" data-bs-toggle="dropdown" data-bss-hover-animate="pulse" type="button" style="margin-left: 230px;margin-top: 0px;">Pilih Surat</button>
                                        <div class="dropdown-menu show" data-bs-popper="none"><a class="dropdown-item" href="#">Surat Keterangan Tidak Mampu</a><a class="dropdown-item" href="#">Surat Kematian</a><a class="dropdown-item" href="#">Surat Pengantar Izin Keramaian</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
