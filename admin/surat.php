        ...
        <div class="page-title">
          <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
              <h3 class="mb-4">Data Surat yang sedang di proses</h3>
            </div>
              ...
              <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">
                    Data Surat yang sedang di proses
                  </li>
                </ol>
              </nav>
            </div>
                ...
                <div class="card-content">
                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered mb-0">
                      ...
                      <tbody>
                        <tr>
                          <td class="text-bold-500">Pengajuan Pembuatan KTP</td>
                          <td>Abdul Rohimin</td>
                          <td class="text-bold-500">TTD RT & RW</td>
                          <td>Belum </td>
                          <td>Belum</td>
                          <td>
                            <a href="#"> <button type="button" class="btn btn-danger"> Lihat Pengajuan</button></a>
                            <a href="#"> <button type="button" class="btn btn-primary"> Cetak Surat </button></a>
                          </td>
                          </td>

                        </tr>
                        <tr>
                          <td class="text-bold-500">Pengajuan Pembuatan KK</td>
                          <td>Angga Saeful Umam</td>
                          <td class="text-bold-500">TTD RT & RW</td>
                          <td>Sudah</td>
                          <td>Belum</td>
                          <td>
